        ...
        if (isAlreadySelected) {
          ...
          if (machine) {
            if (machine.type === "Machine à laver") {
              ...
              updatedWeights[machineId] = machine.weightCapacity; // Default weight for other types
            }
          }
        }
        ...
        for (const machineId of selectedMachines) {
          ...
          if (machine) {
            ...
            if (isWashingMachine && formData.etat === "encaisser") {
              showModalInfo = true;
              setMessage("Machine non Disponible pour l'instant");
              break; // Stopper la boucle si une condition échoue
            }
          }
        }
