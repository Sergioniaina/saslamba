  ...
  return (
    <div className="abonnements">
      ...
      <div className="table-abonnement">
        ...
        <div className={`details ${selectedAbonnement ? "show" : ""}`}>
          {selectedAbonnement && (
            <>
              <button
              ...
              <p>
                <strong>Nom:</strong> {selectedAbonnement.nom}
              </p>
              <p>
                <strong>Machines:</strong> {selectedAbonnement.machines}
              </p>
              <p>
                <strong>Poids:</strong> {selectedAbonnement.poids}
              </p>
              <p>
                <strong>Prix:</strong> {selectedAbonnement.prix}
              </p>
              <p>
                <strong>Caractéristiques:</strong>{" "}
                {selectedAbonnement.features.join(", ")}
              </p>
            </>
          )}
        </div>
